...
- **1 semana** de buffer para testing
...
> Este proyecto representa la evolución natural del sistema de comunicaciones AlephScript hacia capacidades P2P modernas, manteniendo la compatibilidad total con la arquitectura existente y proporcionando una base sólida para futuras expansiones WebRTC.
